defmodule Astar.HeapMap.ExCheck.Test do
  ...
  describe "Property tests" do
    ...
    property "pop gives item with smallest priority [2 items]" do
      ...
      for_all {pri1, pri2, k1, k2, v} in such_that(
                {_, _, k1, k2, _} in {int(), int(), any(), any(), any()}
                when k1 !== k2
              ) do
    ...
    property "pop leaves mapping int()act" do
      ...
      for_all {p1, p2, p3, k1, k2, k3, v1, v2, v3} in such_that(
                {_, _, _, k1, k2, k3, _, _, _} in {int(), int(), int(), any(), any(), any(),
                 any(), any(), any()}
